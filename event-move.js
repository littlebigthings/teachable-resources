    ...
    resetTab(target) {
        if (target != undefined || target != null) {
            ...
            if (this.tabItem.getAttribute("isactive") == "true" && this.checkFirst != "0") {
                ...
                (window.screen.width < 479)&&gsap.to(this.tabItem, { display:"none", ease: "circ.out", duration: 0.2, });
    ...
    listenToevents() {
        this.tabItem.addEventListener("click", (e) => {
            if (this.tabItem.getAttribute("isactive") == "false") {
                ...
                (window.screen.width < 479)&&gsap.to(e.currentTarget, {display:"flex", ease: "circ.out", duration: 0, });
                ...
                (window.screen.width < 479)&&gsap.to(e.currentTarget, {display:"none", ease: "circ.out", duration: 0, });
                gsap.to(this.toOpenCloseWrp, { height: 0, ease: "circ.out", duration: 0.2, });
